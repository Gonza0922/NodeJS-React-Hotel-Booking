...
imagesRouter.post("/update/single/:hotel_ID", validateTokenPartner, putSingleImages);
imagesRouter.post("/update/multiple/:hotel_ID", validateTokenPartner, putMultipleImages);
imagesRouter.get("/delete/single/:hotel_ID", validateTokenPartner, deleteSingleImages);
